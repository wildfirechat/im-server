    ...
    public boolean action(Request request) {
        if (request.getNettyRequest() instanceof FullHttpRequest) {
            ...
            if (inputAddGroupMember.isValide()) {
                ServerAPIHelper.sendRequest(inputAddGroupMember.getOperator(), null, IMTopic.AddGroupMemberTopic, inputAddGroupMember.toProtoGroupRequest().toByteArray(), inputAddGroupMember.getOperator(), TargetEntry.Type.TARGET_TYPE_USER, new ServerAPIHelper.Callback() {
                    @Override
